  ...
  const handleFileUpload = (event) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        setError(
          `Error parsing ${uploadMode.toUpperCase()} file: ${err.message}`
        );
      ...
      <main className="main">
        ...
        {activeTab === "results" && results && (
          <ResultsTab
            ...
            onOpenHelp={() => setShowHelp('results')}
          />
        )}
        {activeTab === 'balances' && results && (
          <BalancesTab results={results} onOpenHelp={() => setShowHelp('balances')} />
        )}
        {activeTab === 'tax' && results && (
          <TaxTab results={results} onOpenHelp={() => setShowHelp('tax')} />
        )}
      </main>

      <Footer />

      {showHelp && <HelpModal variant={showHelp} onClose={() => setShowHelp(null)} />}
    </div>
  );
}

  ...
  return jsonData.map((row) => {
    ...
    Object.entries(row).forEach(([key, value]) => {
      ...
      if (normalizedKey === "from_coin") {
        ...
        normalizedKey.includes("exchange") ||
